...
SubShader { 
 ...
 //       gles3 : 0 math, 1 texture
 //   glesdesktop : 0 math, 1 texture
 //       metal : 5 math
 //      opengl : 9 math
...
SetTexture 0 [_PalTex] 2D 0
"ps_4_0
eefiecednecjgoioobdepbigeldeklffccnbjlmlabaaaaaafiabaaaaadaaaaaa
...
fdfgfpfegbhcghgfheaaklklfdeieefcgeaaaaaaeaaaaaaabjaaaaaafkaaaaad
aagabaaaaaaaaaaafibiaaaeaahabaaaaaaaaaaaffffaaaagfaaaaadpccabaaa
aaaaaaaaefaaaaampccabaaaaaaaaaaaaceaaaaaaaaahmdpaaaadadpaaaaaaaa
