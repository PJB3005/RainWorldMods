// Compiled shader for all platforms, uncompressed size: 23.8KB

Shader "Futile/FlatLightBehindTerrain" {
Properties {
...
SubShader { 
 ...
 //       d3d11 : 7 math
 //        d3d9 : 9 math
 //        gles : 41 math, 2 texture, 4 branch
 //       gles3 : 41 math, 2 texture, 4 branch
 //   glesdesktop : 41 math, 2 texture, 4 branch
 //       metal : 5 math
 //      opengl : 9 math
 // Stats for Fragment shader:
 //       d3d11 : 29 math, 2 texture, 4 branch
 //        d3d9 : 65 math, 2 texture, 1 branch
 //       metal : 41 math, 2 texture, 4 branch
...
SubProgram "d3d11 " {
// Stats: 29 math, 2 textures, 4 branches
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedappkpbdodepokbnjmhmbdjlpgkhiipalabaaaaaabaagaaaaadaaaaaa
...
fdfgfpfegbhcghgfheaaklklfdeieefcbmafaaaaeaaaaaaaehabaaaafjaaaaae
...

...

